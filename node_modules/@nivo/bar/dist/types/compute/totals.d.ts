...
export declare const computeBarTotals: <RawDatum extends BarDatum>(bars: ComputedBarDatum<RawDatum>[], xScale: ScaleBand<string> | AnyScale, yScale: ScaleBand<string> | AnyScale, layout: BarCommonProps<RawDatum>["layout"] | undefined, groupMode: BarCommonProps<RawDatum>["groupMode"] | undefined, totalsOffset: number, formatValue: (value: number) => string) => BarTotalsData[];
